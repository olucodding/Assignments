<?php
include_once 'Dbh3.php';
// session_start();

//user authentication class
class UserAuth extends Dbh3
{
    // private static $db;
    //creating new object of class Dbh2
    ...
    public function register($fullname, $email, $password, $confirmPassword, $country, $gender)
    {
        ...
        if ($this->confirmPasswordMatch($password, $confirmPassword)) {
            ...
            if ($this->$conn->query($sql)) {
                echo "User data registered successfully";
            } else {
                echo "Sorry we just run into a glitch kindly check the data you entered and try again" . $this->$conn->error;
            }
        }
    }
    ...
    //fetches all users data on login
